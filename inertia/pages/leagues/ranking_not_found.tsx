...
const RankingNotFound: React.FC<Props> = ({ league, canManage, slug }) => {
  return (
    <>
      ...
      <p>
        There is no ranking <strong>{slug}</strong> in {league.name}.
      </p>
      <p className="not-found-back">
        <Link route="rankings.index" routeParams={{ league: league.slug }}>
          Back to rankings
        </Link>
      </p>
    </>
